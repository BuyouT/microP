...
LOOP:
	...
	cpi r16, 0x7A	;Check if it's greater or equal than 0x7A
	brge LOOP		;If true go to LOOP
	cpi r16, 0x30	;Check if it's less than 0x30
	brlt LOOP		;If true go to LOOP
	cpi r16, 0x61	;Check if it's less than 0x60
	brlt NEXT		;If true go to next
	subi r16, 0x20	;subtract 0x20 to r16
NEXT:
